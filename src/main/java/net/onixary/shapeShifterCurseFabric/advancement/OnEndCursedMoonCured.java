...
public class OnEndCursedMoonCured extends SimpleCriterionTrigger<OnEndCursedMoonCured.Condition> {
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(ShapeShifterCurseFabric.MOD_ID, "on_end_cursed_moon_cured");

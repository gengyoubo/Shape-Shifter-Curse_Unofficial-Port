...
public class OnEndCursedMoonCuredForm2 extends SimpleCriterionTrigger<OnEndCursedMoonCuredForm2.Condition> {
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(ShapeShifterCurseFabric.MOD_ID, "on_end_cursed_moon_cured_form_2");

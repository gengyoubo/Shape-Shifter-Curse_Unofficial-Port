...
public class OnSleepWhenHaveTransformEffect extends SimpleCriterionTrigger<OnSleepWhenHaveTransformEffect.Condition> {
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(ShapeShifterCurseFabric.MOD_ID, "on_sleep_when_have_transform_effect");

...
public class OnTransformByCatalyst extends SimpleCriterionTrigger<OnTransformByCatalyst.Condition> {
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(ShapeShifterCurseFabric.MOD_ID, "on_transform_by_catalyst");

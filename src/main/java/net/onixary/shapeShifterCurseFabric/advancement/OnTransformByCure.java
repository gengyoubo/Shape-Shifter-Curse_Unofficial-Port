...
public class OnTransformByCure extends SimpleCriterionTrigger<OnTransformByCure.Condition> {
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(ShapeShifterCurseFabric.MOD_ID, "on_transform_by_cure");

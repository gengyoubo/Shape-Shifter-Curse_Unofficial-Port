...
public class OnTriggerCursedMoon extends SimpleCriterionTrigger<OnTriggerCursedMoon.Condition> {
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(ShapeShifterCurseFabric.MOD_ID, "on_trigger_cursed_moon");

...
public class OnTriggerCursedMoonForm2 extends SimpleCriterionTrigger<OnTriggerCursedMoonForm2.Condition> {
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(ShapeShifterCurseFabric.MOD_ID, "on_trigger_cursed_moon_form_2");
